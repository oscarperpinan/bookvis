...
#+begin_src R :results output graphics file :exports both :file "figs/CO2_GNI.pdf" 
## lattice version
...
#+begin_src R :results output graphics file :exports both :file "figs/hclust.pdf" 
...
#+begin_src R :results output graphics file :exports both :file "figs/CO2_capitaDL.pdf"
...
#+begin_src R :results output graphics file :exports both :file "figs/CO2_capita_panel.pdf"
## lattice version
...
#+begin_src R :results output graphics file :exports both :file "figs/CO2_capita_panel_labels.pdf"
## lattice version
xyplot(GNI.capita  ~ CO2.capita | factor(Year),
       data = CO2data,
       xlab = "Carbon dioxide emissions (metric tons per capita)",
...
#+begin_src R :results output graphics file :exports both :file "figs/CO2pointsGG.pdf" 
ggplot(data = CO2data,
       aes(x = CO2.capita,
           y = GNI.capita,
           colour = Country.Name)) +
...
#+begin_src R :results output graphics file :exports both :file "figs/CO2points.pdf" 
