...
#+begin_src R :results output graphics file :exports both :file figs/aranjuezSplom.png :width 4000 :height 4000 :res 600
...
#+begin_src R -n -r :results output graphics file :exports both :file figs/aranjuezSplomHexbin.pdf
library("hexbin")
...
#+begin_src R :results output graphics file :exports both :file figs/aranjuezHexbinplot.pdf
...
#+begin_src R :results output graphics file :exports both  :width 2000 :height 2000 :res 300 :file figs/aranjuezFacetGrid.png
...
#+begin_src R :results output graphics file :exports both :file figs/aranjuezOuterStrips.pdf
useOuterStrips(
