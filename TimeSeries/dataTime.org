...
cite:SIAR2024 is a free-download database operating since 1999,
...
World Development Indicators (WDI)[fn:3]. Among them we will analyse
the Gross National Income (GNI) for a set of countries from 2000
to 2021.
...
#+RESULTS:
#+begin_example
 Country.Name          iso2c           Country.Code            Year     
 Length:176         Length:176         Length:176         Min.   :2000  
 ...
 Mode  :character   Mode  :character   Mode  :character   Median :2010  
                                                          ...
                                                          Max.   :2021  
    GNI.PPP            GNI.capita      Population       
 Min.   :1.638e+11   Min.   : 2070   Min.   :4.491e+06  
 1st Qu.:7.724e+11   1st Qu.:20108   1st Qu.:3.321e+07  
 Median :2.655e+12   Median :31870   Median :7.406e+07  
 Mean   :5.451e+12   Mean   :33149   Mean   :3.885e+08  
 3rd Qu.:7.252e+12   3rd Qu.:47085   3rd Qu.:5.135e+08  
 Max.   :2.862e+13   Max.   :89010   Max.   :1.414e+09
#+end_example

#+INDEX: Data!Climate Watch
#+INDEX: Data!CO2 emissions@$CO_2$ emissions

On the other hand, the data explorer of the Climate Watch website publishes the historical values of $CO_2$ emissions[fn:5], and can be downloaded as a CSV file.
#+begin_src R
...
These two =data.frames= are to be merged together. First, we filter =CWdata= to preserve the same countries that are contained in =WDIdata=. 
#+begin_src R
## Filter by countries
...
Then, it is transformed from wide to long format with the function =melt= of the package =reshape2=.
...
Now they can be merged together and a new variable is
calculated, =CO2.capita=.
#+begin_src R
...
Finally, the =Country.Code= and =Country.Name= variables are converted
to =factors=, which will be useful with some graphics.
#+begin_src R
...
#+RESULTS:
#+begin_example
  Country.Code      Year       Country.Name    iso2c              GNI.PPP         
 CHN    :22    Min.   :2000   China  :22    Length:176         Min.   :1.638e+11  
 DEU    :22    1st Qu.:2005   France :22    Class :character   1st Qu.:7.724e+11  
 ESP    :22    Median :2010   Germany:22    Mode  :character   Median :2.655e+12  
 FRA    :22    Mean   :2010   Greece :22                       Mean   :5.451e+12  
 GRC    :22    3rd Qu.:2016   India  :22                       3rd Qu.:7.252e+12  
 IND    :22    Max.   :2021   Norway :22                       Max.   :2.862e+13  
 (Other):44                   (Other):44                                          
   GNI.capita      Population             CO2             CO2.capita         CO2.PPP       
 Min.   : 2070   Min.   :4.491e+06   Min.   :   15.51   Min.   : 0.6762   Min.   :0.04652  
 1st Qu.:20108   1st Qu.:3.321e+07   1st Qu.:  167.38   1st Qu.: 4.1302   1st Qu.:0.13574  
 Median :31870   Median :7.406e+07   Median :  471.87   Median : 5.6616   Median :0.24272  
 Mean   :33149   Mean   :3.885e+08   Mean   : 1928.00   Mean   : 6.7633   Mean   :0.27305  
 3rd Qu.:47085   3rd Qu.:5.135e+08   3rd Qu.: 2566.51   3rd Qu.: 8.9374   3rd Qu.:0.34425  
 Max.   :89010   Max.   :1.414e+09   Max.   :10849.18   Max.   :19.0211   Max.   :0.83932  
...
* Footnotes
[fn:5]https://www.climatewatchdata.org/data-explorer/historical-emissions 
...
[fn:4] https://servicio.mapa.gob.es/websiar/
