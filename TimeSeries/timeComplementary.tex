...
\caption{\label{fig:org7b3c9a3}
GNI per capita versus \(\mathrm{CO_2}\) emissions per capita (\texttt{lattice} version).}
\end{figure}
...
\caption{\label{fig:org50b3144}
Hierarchical clustering of the time evolution of \(\mathrm{CO_2}\) per capita values.}
\end{figure}
...
\caption{\label{fig:org8261a86}
\(\mathrm{CO_2}\) emissions versus GNI per capita. Labels are placed with \texttt{panel.pointLabel}.}
\end{figure}
...
\caption{\label{fig:org9ed9b8b}
\(\mathrm{CO_2}\) emissions versus GNI per capita. Labels are placed with the \texttt{extreme.grid} method of the \texttt{directlabels} package.}
\end{figure}
...
\caption{\label{fig:orga43832e}
\(\mathrm{CO_2}\) emissions versus GNI per capita with a panel for each year.}
\end{figure}
...
\caption{\label{fig:org1693900}
\(\mathrm{CO_2}\) emissions versus GNI per capita for different intervals of the ratio of \(\mathrm{CO_2}\) emissions to the GDP PPP estimations.}
\end{figure}
...
\caption{\label{fig:org6b9977a}
\(\mathrm{CO_2}\) emissions versus GNI per capita for different intervals of the ratio of \(\mathrm{CO_2}\) emissions to the GDP PPP estimations.}
\end{figure}

\section{\floweroneleft Traveling Bubbles}
\label{sec:org8e37515}
