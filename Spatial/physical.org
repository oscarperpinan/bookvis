...
- =terra= for reading and manipulating raster data.
...
- =rnaturalearth= and =geodata= for retrieving data from the NaturalEarth[fn:3] and the GeoData[fn:5] services, respectively.
...
#+INDEX: Packages!rnaturalearth@\texttt{rnaturalearth}
  ...
  1. The administrative boundaries are available from Natural
     Earth with the packages =rnaturalearth= and
  ...
  2. The terrain elevation or digital elevation model (DEM) is
     available from the DIVA-GIS service with the =geodata= package,
...
cite:Ihaka.Murrell.ea2024. The theme for the graphic is configured via
...
\begin{figure}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/brazilDEMLattice.png}
    \end{center}
    \subcaption{\texttt{lattice} version}
    \label{fig:brazilDEMlattice}
  \end{minipage}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/brazilDEMGG.png}
    \end{center}
    \subcaption{\texttt{ggplot2} version}
    \label{fig:brazilDEMGG}
  \end{minipage}
...
\begin{figure}
  \centering
  \begin{minipage}{0.4\textheight}
    \includegraphics[width=\textwidth]{figs/Spatial/brazilLattice.png}
    \subcaption{\texttt{lattice} version}
    \label{fig:brazilLattice}
  \end{minipage}
  \vfill
  \begin{minipage}{0.4\textheight}
    \includegraphics[width=\textwidth]{figs/Spatial/brazilGG.png}
    \subcaption{\texttt{ggplot2} version}
    \label{fig:brazilGG}
  \end{minipage}
