...
4. The administrative boundaries represented by the
  ...
  #+begin_src R :results output graphics file :exports both :file figs/brazil.png :width 2000 :height 2000 :res 300
...
#+begin_src R :results output graphics file :exports results :file figs/rastersBrazil.png :width 2000 :height 2000 :res 300
