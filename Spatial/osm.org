...
Several packages are employed to produce the map:

- =raster= and =terra= for reading and manipulating raster data.
- =sp= and =sf= for reading and manipulating spatial vector data.
...
- =rasterVis= and =tidyterra= for creating maps with =lattice= and =ggplot2=, respectively.
- =RColorBrewer= and =colorspace= for defining the palette of colours.  
...
library("colorspace")
#+end_src
- =osmdata= for retrieving data from OpenStreetMap.
...
\begin{figure}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraHSlattice.pdf}
    \end{center}
    \subcaption{\texttt{lattice} version.}
    \label{fig:cedeiraHSlattice}
  \end{minipage}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraHSggplot.pdf}
    \end{center}
    \subcaption{\texttt{ggplot2} version.}
    \label{fig:cedeiraHSggplot}
  \end{minipage}
  \caption{Local topography of Cedeira (Galicia, Spain) displayed with the hill shading technique.}
  \label{fig:cedeiraHS}
\end{figure}
#+end_export
...
\begin{figure}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraDEMlattice.pdf}
    \end{center}
    \subcaption{\texttt{lattice} version.}
    \label{fig:cedeiraDEMlattice}
  \end{minipage}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraDEMggplot.pdf}
    \end{center}
    \subcaption{\texttt{ggplot2} version.}
    \label{fig:cedeiraDEMggplot}
  \end{minipage}
  \caption{Local topography of Cedeira (Galicia, Spain).}
  \label{fig:cedeiraDEM}
\end{figure}
#+end_export
...
\begin{figure}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraOSMlattice.pdf}
    \end{center}
    \subcaption{\texttt{lattice} version.}
    \label{fig:cedeiraOSMlattice}
  \end{minipage}
  \begin{minipage}{0.4\textheight}
    \begin{center}
      \includegraphics[width=\textwidth]{figs/Spatial/cedeiraOSMggplot.pdf}
    \end{center}
    \subcaption{\texttt{ggplot2} version.}
    \label{fig:cedeiraOSMggplot}
  \end{minipage}
