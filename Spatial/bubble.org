...
#+CAPTION: Annual average of $NO_2$ measurements in Madrid. Enhancement of Figure ref:fig:airMadrid_spplot, using symbol sizes proposed by Borden Dent and a better key. label:fig:airMadrid_classes
...
to cite:Cressie.Wikle2015 and cite:Bivand.Pebesma.ea2008.
