...
#+begin_src R :results output graphics :exports both :file figs/colors_approxFun.pdf
####################
## Con approxfun
...
#+begin_src R :results output graphics :exports both :file figs/colors_findInterval.pdf
## Con findInterval
...
#+begin_src R :results output graphics :exports both :file figs/colors_lineEquation.pdf
...
# #+begin_src R :results output graphics :exports both :file figs/colors.pdf
# levelplot(r, par.settings=RdBuTheme, at=pretty(rgExt, 15))
# #+end_src


#+begin_src R :results output graphics :exports both :file figs/colors_classInt.pdf
  ## classInt
  library(raster)
  library(rasterVis)
  library(classInt)
...
## x11(); levelplot(r, par.settings=rasterTheme(region=pal2),
##           at=cl$brks)

## Además, al usar rasterTheme usamos custom.theme por
## extensión. Esta función crea una paleta con 100 colores
## (siempre) a partir de la que nosotros pasamos usando
## colorRampPalette. Por tanto, independientemente de que
## empleemos pal o pal2, levelplot recibirá una paleta de 100
## colores interpolados. Si queremos ser muy certeros en los
## colores empleados hay que asignar directamente los colores
## después de creado el tema.


#+begin_src R :results output graphics :exports both :file figs/colors_classInt_brks.pdf
myTheme <- rasterTheme()
...
## myTheme$regions$col <- pal2
## x11(); levelplot(r, par.settings=myTheme, at=cl$brks)
#+end_src
