...
** COMMENT Displaying Time Series: Introduction
 label:cha:timeIntro
...
** COMMENT Time on the Horizontal Axis
...
** COMMENT Time as a Conditioning or Grouping Variable
...
** COMMENT Time as a Complementary Variable
