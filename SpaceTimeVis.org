...
\nomenclature{SpatialLinesDataFrame}{A class that holds data consisting of sets of lines, where each set of lines relates to an attribute row in a data.frame}
