...
** Displaying Spatial Data: Introduction
 ...
 This part exposes several examples where vector and raster data are displayed to show geographic location of features and physical landscape features of a place (reference and physical maps, Chapter ref:cha:refer-phys-maps) or a specific variable in the context of a geographic reference (thematic maps, Chapters ref:cha:bubble, ref:cha:choropleth, and ref:cha:raster). These examples make use of several datasets (available at the book website) described in Chapter ref:cha:dataSpatial.
