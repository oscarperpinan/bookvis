...
\nomenclature{RasterLayer}{A class to represent single-layer (variable) raster data with the \texttt{raster} package.}
...
\nomenclature{RasterBrick}{A class to represent multilayer (variable) raster data with the \texttt{raster} package.}
\nomenclature{RasterStack}{A class to represent multilayer (variable) raster data with the \texttt{raster} package.}
...
\nomenclature{SpatRaster}{A class to represent raster data with the \texttt{terra} package.}
\nomenclature{SpatVector}{A class to represent spatial vector data with the \texttt{terra} package.}
...
\chapterprecishere{%
  ...
  \textttt{RColorBrewer} for palettes of colours; \texttt{classInt}
...
\chapterprecishere{%
  ...
  \texttt{colorspace} and \textttt{RColorBrewer} for palettes of
  colours; \textttt{rnaturalearth} and \textttt{geodata} for
...
\chapterprecishere{%
  ...
  visualization; \textttt{gganimate} for animation with
  \texttt{ggplot2}.
  %
}
#+END_EXPORT
