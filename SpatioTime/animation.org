...
#+CAPTION: Trajectories of the lesser kestrels in the different months included in the study. Each individual is represented by a different color. label:fig:trajectoriesGG
#+RESULTS:
...
#+CAPTION: Polar representation of the histogram of flight directions, using a different color for each speed class. label:fig:trajectoriesPolar
#+RESULTS:
...
#+CAPTION: Snapshot of the animation of the trajectories. label:fig:trajectorySnapshot
