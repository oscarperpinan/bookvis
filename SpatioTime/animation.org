...
The procedure for point space-time data is more complex than for raster data. This section details a method built over the functionalities of the =gridSVG= package.
