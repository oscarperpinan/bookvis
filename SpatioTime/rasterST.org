...
#+begin_src R :results output graphics file :exports both :file figs/SISdm.pdf
...
#+begin_src R :results output graphics file :exports both :file figs/SISmm.pdf
...
#+begin_src R :results output graphics file :exports both :file figs/SISdm_histogram.pdf
...
#+begin_src R :results output graphics file :exports both :file figs/SISdm_boxplot.pdf
...
#+begin_src R :results output graphics file :exports both :file figs/SISmm_splom.png :width 4000 :height 4000 :res 600
...
#+begin_src R :results output graphics file :exports both :file figs/SISdm_hovmoller_lat.png :width 4000 :height 4000 :res 600
hovmoller(SISdm)
#+end_src
...
#+begin_src R :results output graphics file :exports both :file figs/SISmm_xyplot.pdf
...
#+INDEX: Subjects!Small multiples
#+begin_src R :results output graphics file :exports both :file figs/SISdm_horizonplot.pdf
