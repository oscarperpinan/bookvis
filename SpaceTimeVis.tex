...
\label{sec:orga3afad9}
\label{sec:introduction}



\part{Time Series}
\label{sec:orgc6d0b1a}

\chapter{Displaying Time Series: Introduction}
\label{sec:org2afc94d}
\label{cha:timeIntro}
