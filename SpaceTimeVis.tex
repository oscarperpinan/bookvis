...
\label{sec:org014af0b}
\label{sec:introduction}



\part{Time Series}
\label{sec:orgf55369f}

\chapter{Displaying Time Series: Introduction}
\label{sec:orgce1d6a7}
\label{cha:timeIntro}
...
\section{Interactive}
\label{sec:org43562c9}
\subsection{\texttt{googleVis}}
\label{sec:org00e9c57}
